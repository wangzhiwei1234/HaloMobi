...
import com.example.ggxiaozhi.store.the_basket.mvp.view.activity.uploadeApkActivity;
...
public class MyFragment extends BaseFragment {
    ...
    protected View cretaeSuccessView() {
        ...
        check_update_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mBaseActivity.startActivity(new Intent(getContext(),uploadeApkActivity.class));
            }
        });
        return view;
    }
